    	...
    	var navHeightT = 0.75*pageHeightT;
    	var navWidthT = 0.7*pageWidthT;
        /*var styles = {
      		height : "$(navHeightT) px"
      	};*/
        console.log("Calling wellTabs.js ..... ");
        ...
        $( document ).ready(function() {
        	//if(wellHeightT > pageHeightT){
        		...
        		$("div.well").css('max-height', navHeightT+'px');
        	...
        	//if(wellWidthT < pageWidthT){
        		...
        		$("div.well").css('max-width', navWidthT+'px');
        ...
        $( window ).bind("resize", function(){
            ...
            console.log("Calling resize from wellTabs.js ....");
            ...
            var navHeightTN = 0.75*pageHeightTN;
            var navWidthTN = 0.7*pageWidthTN;
            /*$("div.well").width( navWidthTN );
            $("div.well").height( navHeightTN );*/
            if(wellHeightTN > pageHeightTN){
                $("div.well").css({"overflow-y": "scroll"});
                $("div.well").css('max-height', navHeightTN+'px');
            }
            if(wellWidthTN < pageWidthTN){
                $("div.well").css('max-width', navWidthTN+'px');
            }
